...
const (
	...
	Address_DeletcAddress_FullMethodName  = "/Address/DeletcAddress"
)
...
type AddressClient interface {
	...
	DeletcAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *addressClient) DeletcAddress(ctx context.Context, in *AddressRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Address_DeletcAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddressServer interface {
	...
	DeletcAddress(context.Context, *AddressRequest) (*emptypb.Empty, error)
...
func (UnimplementedAddressServer) DeletcAddress(context.Context, *AddressRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeletcAddress not implemented")
}
...
func _Address_DeletcAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddressServer).DeletcAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Address_DeletcAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressServer).DeletcAddress(ctx, req.(*AddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Address_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeletcAddress",
			Handler:    _Address_DeletcAddress_Handler,
		},
	},
