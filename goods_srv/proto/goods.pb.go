...
type CategoryBrandResponse struct {
	...
	Id       int32                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Category *CategoryInfoResponse `protobuf:"bytes,2,opt,name=category,proto3" json:"category,omitempty"`
	Brand    *BrandInfoResponse    `protobuf:"bytes,3,opt,name=brand,proto3" json:"brand,omitempty"`
}
...
func (x *OneInfoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OneInfoResponse) ProtoMessage() {}

func (x *OneInfoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_goods_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OneInfoResponse.ProtoReflect.Descriptor instead.
func (*OneInfoResponse) Descriptor() ([]byte, []int) {
	return file_goods_proto_rawDescGZIP(), []int{22}
}

func (x *OneInfoResponse) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *OneInfoResponse) GetIsTab() bool {
	if x != nil {
		return x.IsTab
	}
	return false
...
var file_goods_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x02, 0x69, 0x64, 0x12, 0x31, 0x0a, 0x08, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72,
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	...
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x42, 0x72, 0x61, 0x6e, 0x64, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x05, 0x62, 0x72, 0x61,
	0x6e, 0x64, 0x22, 0x5d, 0x0a, 0x0d, 0x42, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	...
	0x37, 0x0a, 0x0f, 0x4f, 0x6e, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x08, 0x52, 0x05, 0x69, 0x73, 0x54, 0x61, 0x62, 0x22, 0x21, 0x0a, 0x0f, 0x47, 0x6f, 0x6f, 0x64,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0xe1, 0x03, 0x0a, 0x0f,
	...
	0x52, 0x09, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x4e, 0x75, 0x6d, 0x73, 0x22, 0x9a, 0x02, 0x0a, 0x12,
	...
	0x05, 0x52, 0x05, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x22, 0xdd, 0x04, 0x0a, 0x11, 0x47, 0x6f, 0x6f,
...
var file_goods_proto_goTypes = []interface{}{
	...
	(*OneInfoResponse)(nil),            // 22: OneInfoResponse
...
var file_goods_proto_depIdxs = []int32{
	...
	15, // 4: CategoryBrandResponse.brand:type_name -> BrandInfoResponse
