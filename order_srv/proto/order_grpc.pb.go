...
const (
	...
	Order_UpdateOrderStstus_FullMethodName = "/Order/UpdateOrderStstus"
)
...
type OrderClient interface {
	...
	OrderList(ctx context.Context, in *OrderFilterRequest, opts ...grpc.CallOption) (*OrderListReponse, error)
	OrderDetail(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*OrderInfoDetailResponse, error)
	UpdateOrderStstus(ctx context.Context, in *OrderStatus, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *orderClient) OrderList(ctx context.Context, in *OrderFilterRequest, opts ...grpc.CallOption) (*OrderListReponse, error) {
	out := new(OrderListReponse)
...
func (c *orderClient) UpdateOrderStstus(ctx context.Context, in *OrderStatus, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Order_UpdateOrderStstus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	OrderList(context.Context, *OrderFilterRequest) (*OrderListReponse, error)
	OrderDetail(context.Context, *OrderRequest) (*OrderInfoDetailResponse, error)
	UpdateOrderStstus(context.Context, *OrderStatus) (*emptypb.Empty, error)
...
func (UnimplementedOrderServer) OrderList(context.Context, *OrderFilterRequest) (*OrderListReponse, error) {
...
func (UnimplementedOrderServer) UpdateOrderStstus(context.Context, *OrderStatus) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrderStstus not implemented")
}
...
func _Order_UpdateOrderStstus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderStatus)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).UpdateOrderStstus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_UpdateOrderStstus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).UpdateOrderStstus(ctx, req.(*OrderStatus))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateOrderStstus",
			Handler:    _Order_UpdateOrderStstus_Handler,
		},
	},
